...
public class LinkedList {
    ...
    /**
     * Replaces the event at the specified index with the updated event.
     *
     * @param index The index of the event to replace
     * @param updatedEvent The updated event to set at the specified index
     */
    public void set(int index, Event updatedEvent) {
        if (index < 0 || index >= size) {
            throw new IndexOutOfBoundsException("Index out of bounds.");
        }
        ...
        current.event = updatedEvent;  // Replace the event at the specified index
    }
}