...
public class UserInterface {
	...
	private void addAttendee(JTextArea textArea) {
		...
		String phoneNumber = JOptionPane.showInputDialog(frame, "Enter attendee phone:");
	...
	private void editAttendee(JTextArea textArea) {
		...
		try {
			...
			String phoneNumber = JOptionPane.showInputDialog(frame, "Enter new phone:");
			...
			Attendee updatedAttendee = new Attendee(name, email, phoneNumber);
